...
# если число делится на 5, вывести вместо него Buzz, а если делится и на три, и на 5, то вывести вместо этого числа
# FizzBuzz.
#
# Формат ввода:
...
def func():
    ...
    for i in range(int(my_input[0]), (int(my_input[1]) + 1)):
        if i % 3 == 0 and i % 5 == 0:
            print('FizzBuzz')
        elif i % 3 == 0:
            print('Fizz')
